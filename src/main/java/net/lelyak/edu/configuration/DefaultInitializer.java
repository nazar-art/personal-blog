...
public class DefaultInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Comment commentToFirstPost = Comment.builder().commentText("you an idiot!").user(sailor).post(firstPost).build();
        Comment secondCommentToFirstPost = Comment.builder().commentText("You should sail to Antarctica!").user(sailor).post(firstPost).build();
        Comment commentToSecondPost = Comment.builder().commentText("Shut up!").user(sailor).post(secondPost).build();
        Comment commentToThirdPost = Comment.builder().commentText("You need to go and eat spinach! As much as you can!").user(sailor).post(thirdPost).build();
